...
import com.dasar.chatapp.Adapter.MessageAdapter;
import com.dasar.chatapp.Model.Chat;
import com.dasar.chatapp.Model.User;
import com.dasar.chatapp.Utils.SendNotification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                readMessage(loginUser.getUid(), userid, user.getImageURL());
            }
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.println(Log.INFO, "NOTIFKEY", user.getNotificationKey());
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!msg.equals("")){
                    sendMessage(loginUser.getUid(), userid, msg);
                } else {
                    Toast.makeText(MessageActivity.this, "You Cant send empty", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
